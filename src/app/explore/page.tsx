...
import { MapPin, Search, Loader2, AlertCircle, Filter, Navigation, Phone, Globe, Star } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Explore Businesses</h1>
              <p className="text-gray-600 text-sm">Discover verified businesses around you</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="border rounded-lg px-4 py-2 bg-white flex-1"
              >
              ...
              <CardContent className="p-0 h-full">
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm">Map functionality requires Leaflet.js library</p>
                    <p className="text-gray-500 text-xs mt-2">Install: npm install leaflet react-leaflet</p>
                    <div className="mt-4 bg-blue-50 rounded-lg p-4 text-left text-sm">
                      <p className="font-semibold text-blue-900 mb-2">Current Location:</p>
                      {userLocation ? (
                        <>
                          <p className="text-blue-800">Lat: {userLocation.lat.toFixed(4)}</p>
                          <p className="text-blue-800">Lng: {userLocation.lng.toFixed(4)}</p>
                        </>
                      ) : (
                        <p className="text-blue-800">Detecting location...</p>
                      )}
                    </div>
                  </div>
                </div>
            ...
            {filteredBusinesses.length === 0 ? (
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-500 text-sm mt-1">Try increasing the search radius or changing filters</p>
                </CardContent>
              </Card>
            ) : (
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 text-sm">{business.company_name}</h3>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className={`text-xs font-semibold ${STATUS_COLORS[business.status]}`}>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm font-semibold text-gray-900">{business.trust_score}%</span>
                        </div>
                        <Button
                          size="sm"
                          variant="ghost"
