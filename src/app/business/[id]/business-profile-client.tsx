...
/**
 * The interactive profile. Rendered by page.tsx, which passes in the
 * server-rendered contact card (BusinessContactCard is a Server Component,
 * so it cannot be imported here directly — it arrives as a prop).
 */
export function BusinessProfileClient({ contactCard }: { contactCard?: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Top nav bar */}
      <header className="safe-area-pt sticky top-0 z-30 bg-white/90 backdrop-blur-xl border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <VBLLogo variant="full" size="xs" theme="dark" />
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-4">
            ...
            {/* Contact: website, email, phone and address come from the
                server-rendered BusinessContactCard, which drops any row
                that is empty. Social links stay here. */}
            {contactCard}
