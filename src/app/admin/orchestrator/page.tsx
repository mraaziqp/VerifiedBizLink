...
import { TrendingUp, Users, Building2, DollarSign, Activity, Settings, LogOut } from "lucide-react";
      ...
      <div className="border-b border-gray-800 sticky top-0 z-50 backdrop-blur-xl bg-black/50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">High-level business intelligence & metrics</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl border border-gray-700/50">
            <h2 className="text-xl font-bold text-white mb-6">Business Distribution</h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
        ...
        <div className="mt-6 p-6 rounded-2xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl border border-gray-700/50">
        ...
        <div className="mt-6 p-6 rounded-2xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl border border-gray-700/50">
          ...
          <div className="flex flex-wrap gap-2">
            <Button className="bg-yellow-400 text-gray-900 hover:bg-yellow-300">View All Businesses</Button>
            <Button className="bg-blue-500 text-white hover:bg-blue-600">Export Report</Button>
            <Button variant="outline" className="text-white border-gray-600">View Analytics</Button>
