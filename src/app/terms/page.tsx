...
export default function TermsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black">
      <SubpageNav title="Terms & Conditions" />
        ...
        <div className="prose prose-invert max-w-none">
          <div className="space-y-6 text-gray-300">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>The Platform offers a free tier and paid subscription tiers (billed monthly in South African Rand), described on our <Link href="/pricing" className="text-cyan-400 hover:underline">Pricing</Link> page. Features and prices may change; where a change materially affects an active subscription, we will give reasonable notice before it takes effect at your next renewal.</li>
                <li>Paid subscriptions automatically renew each month until you cancel. Payments are processed by our third-party payment provider, PayFast — we do not store your full card details.</li>
                <li>You can cancel auto-renewal at any time from Settings → Billing. Cancelling downgrades your account to the free tier immediately — it does not automatically refund the current billing period — see our <Link href="/refund-policy" className="text-cyan-400 hover:underline">Refund Policy</Link> for how refunds and cooling-off cancellations work.</li>
                <li>If a monthly payment fails, PayFast may retry it; continued failure may result in your account reverting to the free tier.</li>
              </ul>
            </section>
