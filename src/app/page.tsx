    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <aside className="hidden md:block md:col-span-3 lg:col-span-3 sticky top-6">
            <SidebarLeft />
          </aside>

          {/* Center Column - Main Feed & Post Tool (col-span-6) */}
          <main className="md:col-span-6 lg:col-span-6 flex flex-col gap-6">
            <PostCreator onPostCreated={() => setFeedRefresh(r => r + 1)} />
            <ActivityFeed refreshTrigger={feedRefresh} />
          </main>

          {/* Right Column - Discovery & News (col-span-3) */}
          <aside className="hidden lg:flex md:col-span-3 lg:col-span-3 flex-col gap-6 sticky top-6">
            <ConnectionDiscovery />
            <ComplianceNews />
          </aside>
